...
public class Pelicula {
    ...
    // Añadir socio (controla el aforo máximo de 4)
    ...
    // Modifica el título reemplazando 'a' por 'e' (incluye tildes y mayúsculas)
    public void modificarVocales() {
        this.titulo = this.titulo.replace('a', 'e')
                                .replace('á', 'é')
                                .replace('A', 'E')
                                .replace('Á', 'É');
    }

    // Convierte el título completo a mayúsculas
